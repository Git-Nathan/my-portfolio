      ...
      <div id='services' className='mb-8'>
        <div className='mx-auto mt-16 mb-12 flex max-w-175 flex-col items-center px-12 font-medium'>
          ...
          <div className='mb-8 text-center text-lg md:text-xl'>
            Transparent pricing, no hidden fees — just quality edits that sell properties.
          </div>
        </div>
          ...
          <div className='max-w-76.75 rounded-2xl border-2 border-gray-100 p-8 shadow-xl'>
            ...
            <div className='py-8'>
              <div className='mb-2'>
                ...
                <span className='text-sm text-gray-600'> for videos under 90s</span>
              </div>
              <div>
                <span className='text-3xl font-bold'>$45</span>
                <span className='text-sm text-gray-600'> for videos over 90s</span>
              </div>
            </div>
          ...
          <div className='max-w-76.75 rounded-2xl border-2 bg-black p-8 text-white shadow-2xl'>
            ...
            <div className='py-8'>
              <div className='mb-2'>
                ...
                <span className='text-sm text-gray-400'> for videos under 90s</span>
              </div>
              <div>
                <span className='text-3xl font-bold'>$65</span>
                <span className='text-sm text-gray-400'> for videos over 90s</span>
              </div>
            </div>
